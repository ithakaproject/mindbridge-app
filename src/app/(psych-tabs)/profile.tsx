...
export default function ProfileScreen() {
  ...
  const ACCOUNT_ROWS: {
  ...
  }[] = [
    {
      ...
      onPress: () => router.push('/psych-edit-profile'),
    },
    {
      key: 'availability',
      icon: 'time-outline',
      tint: 'teal',
      title: 'Availability',
      sub: 'Manage your weekly hours',
      onPress: () => router.push({ pathname: '/(psych-tabs)/calendar', params: { mode: 'availability' } }),
    },
    {
      key: 'notifications',
    ...
    },
    {
      ...
      sub: 'Change password',
      onPress: () => router.push('/psych-change-password'),
    },
    {
      key: 'help',
